...
if(isset($_GET['table']) && $_GET['table'] == 'category'){
	...
	foreach($res as $row){
		...
		$tempRow['image'] = (!empty($row['image']))?'<a href="category/'.$row['image'].'" data-lightbox="Category Images"><img src="category/'.$row['image'].'" height=30 ></a>':'<img src="images/logo-half.png" height=30>';
...
// 	echo $sql;
	...
	foreach($res as $row){
		...
		$tempRow['row_order'] = $row['row_order'];
		$tempRow['image'] = (!empty($row['image']))?'<a href="subcategory/'.$row['image'].'" data-lightbox="Sub Category Images"><img src="subcategory/'.$row['image'].'" height=30 ></a>':'<img src="images/logo-half.png" height=30>';
